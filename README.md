...
gf_analysis.ipynb was for searching for trends in the data. trends_analysis.Rmd was used for fitting the time series model. trim.ipynb was used to convert macroeconomic data to appropriate format for time series forecasting. forecastingcsi.pdf illustrated our findings in an interpretable manner.
